...
def test_refund_email_produces_correct_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/refund-nov-2015.html"))
...
def test_merchant_purchase_produces_correct_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/merchant-purchase-nov-2015.html"))
...
def test_mar_2019_selling_produces_correct_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/mar-2019-selling.html"))
...
def test_new_format_dec_2015_email_produces_correct_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/new-format-dec-2015.html"))
...
def test_new_format_feb_2017_email_produces_correct_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/new-format-feb-2017.html"))
...
def test_donation_format_dec_2017_produces_correct_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/donation-dec-2017.html"))
...
def test_format_june_2018_produces_correct_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/june-2018.html"))
...
def test_dec_2018_with_suprious_postage_message_produces_correct_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/dec-2018-with-extra-postage-message.html"))
...
def test_nov_2020_sent_payment_produces_correct_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/nov-2020-sent-payment.html"))
...
def test_totals_in_usd_do_not_produce_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/totals-in-usd-2020.html"))
...
def test_facebook_donation_produces_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/facebook-donation-2020-07.html"))
...
def test_nov_2020_payment_processes_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/nov-2020-payment.html"))
...
def test_jan_2021_payment_in_pln_processes_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/jan-2021-01-PLN.html"))
...
def test_mar_2021_payment_processes_receipt(soup):
    receipts = _find_receipts(datetime.datetime.now(), soup("uk_paypal_email/samples/mar-2021.html"))
